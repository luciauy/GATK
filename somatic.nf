...
process SplitIntervals {
  ...
  input:
  file fasta from fasta_splitintervals
  file fai from fai_splitintervals
  file dict from dict_splitintervals

  output:
  file("intervals/*.intervals") into intervals
...
// }
//
// process FilterByOrientationBias {
//
// }
//
